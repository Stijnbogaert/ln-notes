...
var removeOuterQuotesFromString = (s) => {
...
var fetchCardDataFromScryfall = async (distinctCardNames) => {
  ...
  distinctCardNames.forEach((cardName, idx) => {
...
var ObsidianPluginMtgSettingsTab = class extends import_obsidian2.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian2.Setting(containerEl).setName("Collection CSV").setDesc("The file extension of your collection as a CSV file").addText((text) => text.setPlaceholder(".mtg.collection.csv").setValue(this.plugin.settings.collection.fileExtension).onChange(async (value) => {
    ...
    new import_obsidian2.Setting(containerEl).setName("Card count column name").setDesc("The name of the CSV column used for card counts/quantity").addText((text) => text.setPlaceholder("Count").setValue(this.plugin.settings.collection.countColumn).onChange(async (value) => {
    ...
    new import_obsidian2.Setting(containerEl).setName("Hide Prices").setDesc("Toggles card prices in decklists").addToggle((toggle) => toggle.setValue(this.plugin.settings.decklist.hidePrices).onChange(async (value) => {
